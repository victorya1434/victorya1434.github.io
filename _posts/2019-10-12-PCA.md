...
## The intuition
we called pca a machine learning algorithm (an unsupervised one) because it learn from the data or more concretely, it base on the variance of the data in each dimension in order to remove those which have the small variance.<br/>
